...
def main():
    ...
    #print("Process finished --- %s seconds ---" % (time.time() - start_time))
        print(f'Number of nodes visited using BFS: {optimalpath}')
    ...
    #plt.show()
    #print("Process finished --- %s seconds ---" % (time.time() - start_time))
        print(f'Number of nodes visited using A*: {aStarPath}')
        difference = optimalpath - aStarPath
        print(f'Difference in nodes: {difference}')
